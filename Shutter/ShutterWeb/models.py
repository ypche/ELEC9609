...
class Photo(models.Model):
    photographer = models.ForeignKey('User', related_name='Photo_Author',on_delete=models.CASCADE,null=True,
                              blank=True)

    image_path = models.ImageField(upload_to='album/%m-%Y/',blank=True,null=True)
